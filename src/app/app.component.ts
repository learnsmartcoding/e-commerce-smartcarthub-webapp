...
import { UserProfileModel, UserProfileService } from './service/user-profile.service';
...
export class AppComponent {
  ...
  title = 'SmartCartHub Web App is Running';
  isIframe = false;
  loginDisplay = false;
  ...
  getProfile(){
    this.userProfile.GetUserProfile().subscribe(s=>this.profile=s);
  }
}
